        ...
        <div className="flex flex-col items-center">
          {grandTotalFormatted && (activeStep === 'receipt' || activeStep === 'items') ? (
            <div className="hidden md:flex items-center gap-2">
              <span className="text-xs font-extrabold text-on-surface-variant uppercase tracking-widest">Grand Total</span>
              <span className="text-base font-extrabold font-headline text-primary">{grandTotalFormatted}</span>
            </div>
          ) : isFirstStep ? (
